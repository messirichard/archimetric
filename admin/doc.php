...
`title`,
`content`,
`sl_slide_description`.`url` as `url2`
...
CREATE VIEW listing2 as SELECT `id`, `member_id`, `area_id`, `jenis_usaha_id`, `slug`, `nama_listing`, `image`, `alamat`, `rating`, `phone`, `email`, `website`, `jam_buka`, `deskripsi`, `input_date`, `input_member_id`, `pemilik_member_id`, `views`, `status`, `siup`, `input_admin` FROM `listing`


CREATE VIEW `view_gallery` AS SELECT
`gal_gallery`.`id` AS `id`,
`gal_gallery`.`topik_id` AS `topik_id`,
`gal_gallery`.`image` AS `image`,
`gal_gallery`.`image2` AS `image2`,
`gal_gallery`.`active` AS `active`,
`gal_gallery`.`date_input` AS `date_input`,
`gal_gallery`.`date_update` AS `date_update`,
`gal_gallery`.`insert_by` AS `insert_by`,
`gal_gallery`.`last_update_by` AS `last_update_by`,
`gal_gallery`.`writer` AS `writer`,
`gal_gallery`.`city` AS `city`,
`gal_gallery`.`harga` AS `harga`,
`gal_gallery`.`color` AS `color`,
`gal_gallery`.`orientation` AS `orientation`,
`gal_gallery_description`.`id` AS `id2`,
`gal_gallery_description`.`gallery_id` AS `gallery_id`,
`gal_gallery_description`.`language_id` AS `language_id`,
`gal_gallery_description`.`title` AS `title`,
`gal_gallery_description`.`sub_title` AS `sub_title`,
`gal_gallery_description`.`sub_title_2` AS `sub_title_2`,
`gal_gallery_description`.`content` AS `content`,
`gal_gallery_description`.`features` AS `features` 

from (`gal_gallery` join `gal_gallery_description` on((`gal_gallery`.`id` = `gal_gallery_description`.`gallery_id`)));



INSERT INTO `setting` (`id`, `name`, `label`, `value`, `type`, `hide`, `group`, `dual_language`, `sort`) VALUES
(null, 'career_image', 'Image', '', 'image', 0, 'data', 'n', 1),
(null, 'career_content', 'Content', '', 'text', 0, 'data', 'y', 1);

INSERT INTO `setting` (`id`, `name`, `label`, `value`, `type`, `hide`, `group`, `dual_language`, `sort`) VALUES
(null, 'contact_name', 'Name', '', 'text', 0, 'data', 'y', 1),
(null, 'contact_alamat', 'Alamat', '', 'text', 0, 'data', 'y', 1),
(null, 'contact_telp', 'Telp', '', 'text', 0, 'data', 'y', 1),
(null, 'contact_fax', 'FAX', '', 'text', 0, 'data', 'y', 1),
(null, 'contact_email', 'Telp', '', 'text', 0, 'data', 'y', 1);

INSERT INTO `setting` (`id`, `name`, `label`, `value`, `type`, `hide`, `group`, `dual_language`, `sort`) VALUES
(null, 'about_title', 'Title', '', 'text', 0, 'data', 'y', 1),
(null, 'about_subtitle', 'Sub Title', '', 'text', 0, 'data', 'y', 1),
(null, 'about_short_content', 'Short Content', '', 'text', 0, 'data', 'y', 1),
(null, 'about_content', 'Content', '', 'text', 0, 'data', 'y', 1),
(null, 'about_image_1', 'Image', '', 'image', 0, 'data', 'n', 1),
(null, 'about_section_title_1', 'Title', '', 'text', 0, 'data', 'y', 1),
(null, 'about_section_content_1', 'Content', '', 'text', 0, 'data', 'y', 1),
(null, 'about_section_image_1', 'Image', '', 'image', 0, 'data', 'n', 1),
(null, 'about_section_title_2', 'Title', '', 'text', 0, 'data', 'y', 1),
(null, 'about_section_content_2', 'Content', '', 'text', 0, 'data', 'y', 1),
(null, 'about_section_image_2', 'Image', '', 'image', 0, 'data', 'n', 1),
(null, 'about_section_quote', 'Quote', '', 'text', 0, 'data', 'y', 1),
(null, 'about_image_2', 'Image', '', 'image', 0, 'data', 'n', 1),
(null, 'about_image_2_title', 'Title', '', 'text', 0, 'data', 'y', 1),
(null, 'about_image_2_content', 'Content', '', 'text', 0, 'data', 'y', 1);
