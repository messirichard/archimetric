...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->baseUrl ?>/asset/backend/css/redactor.css" /> -->
    ...
    <div class="header">
        <div class="logo">
            <a href="<?php echo CHtml::normalizeUrl(array('/admin/site/index')); ?>">
                <img src="<?php echo Yii::app()->baseUrl; ?>/asset/backend/images/logo-markdesign-inside.png" alt="Cms Markdesign" />
            </a>
        </div>
            ...
            <ul class="headmenu">
                <li >
                    <a class="dropdown-toggle" href="<?php echo CHtml::normalizeUrl(array('/admin/slide/index')); ?>">
                        <span class="head-icon fa fa-camera"></span>
                ...
                <li >
                    <a class="dropdown-toggle" href="<?php echo CHtml::normalizeUrl(array('/admin/about/index')); ?>">
                        ...
                        <span class="headmenu-label"><?php echo Tt::t('admin', 'About') ?></span>
                    </a>
                </li>
                <li >
                    <a class="dropdown-toggle" href="<?php echo CHtml::normalizeUrl(array('/admin/gallery/index')); ?>">
                        <span class="head-icon fa fa-tag"></span>
                        <span class="headmenu-label"><?php echo Tt::t('admin', 'Project') ?></span>
                    </a>
                </li>
                <li >
                    <a class="dropdown-toggle" href="<?php echo CHtml::normalizeUrl(array('/admin/administrator/index')); ?>">
                        <span class="head-icon fa fa-group"></span>
                        <span class="headmenu-label"><?php echo Tt::t('admin', 'Administrator') ?></span>
                    </a>
                </li>
                <li >
                ...
                <?php /*
                <li >
                    <a class="dropdown-toggle" href="<?php echo CHtml::normalizeUrl(array('/admin/oem/index')); ?>">
                        <span class="head-icon fa fa-gears"></span>
                        <span class="headmenu-label"><?php echo Tt::t('admin', 'OEM') ?></span>
                    </a>
                </li>
                */ ?>
                ...
                <li class="right">
                    <div class="userloggedinfo">
                        ...
                        <div class="userinfo">
                            <h5 style="font-size: 15px;"><?php echo Yii::app()->user->name ?> <small>- <?php echo Yii::app()->user->name ?></small></h5>
                            <ul>
                                <?php /*
                                ...
                                */?>
                                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/home/logout')); ?>" style="font-size: 13px;" ><?php echo Tt::t('admin', 'Sign Out') ?></a></li>
                            </ul>
                        </div>
                    </div>
                </li>
