...
<table width="800" align="center" cellspacing="0" cellpadding="0" style="font-family:Arial,Helvetica,sans-serif; color: #505050">
	<tr>
		<td>
			<a href="<?php echo $baseUrl ?>"><img style="display: block;" src="<?php echo $baseUrl ?>/asset/images/logo-ubs-lifestyle.png" alt=""></a>
		</td>
		<td valign="top">
	...
	<tr>
		<td colspan="2">
			<span style="font-size:24px;">INQUIRY <?php echo $model->invoice_prefix ?><?php echo $model->invoice_no ?></span>
		</td>
	</tr>
	<tr>
		<td colspan="2">
...
<?php
$a = '<a href="'.CHtml::normalizeUrl(array('')).'" ></a>';
?>