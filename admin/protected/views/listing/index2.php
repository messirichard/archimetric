...
<ul>
    ...
    <li><a href="<?php echo CHtml::normalizeUrl(array('/listing/index', 'jenis'=>$_GET['jenis'], 'area'=>$value['area'])); ?>"><?php echo $value['area'] ?></a></li>
    <?php endforeach ?>
</ul>
...
<ul>
    ...
    <li><a href="<?php echo CHtml::normalizeUrl(array('/listing/detail', 'slug'=>$value['slug'])); ?>"><?php echo $value['nama_listing'] ?></a></li>
    <?php endforeach ?>
</ul>
<?php $this->widget('CLinkPager', array(
    'pages' => $data['pages'],
