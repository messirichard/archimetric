...
class PromoController extends ControllerAdmin
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Promo']))
		{
			...
			if($model->validate()){
				...
				try
				{
					$image->saveAs(Yii::getPathOfAlias('webroot').'/images/promo/'.$model->image);
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Promo']))
		{
			...
			if ($model->validate()) {
				...
				$model->save();
				Log::createLog("Promo Update $model->id $model->nama");
	...
	public function actionDelete($id)
	{
			...
			@unlink(Yii::getPathOfAlias('webroot').'/images/promo/'.$data->image);
