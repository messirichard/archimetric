...
<div class="row-fluid">
	<div class="span8">
		...
		<div class="widgetcontent">
			...
			<div class="row-fluid">
				<div class="span12">
					<?php echo $form->textAreaRow($model,'address',array('class'=>'span12','maxlength'=>100)); ?>
				</div>
			</div>
			<div class="row-fluid">
				<div class="span4">
					<?php echo $form->textFieldRow($model,'city',array('class'=>'span12','maxlength'=>100)); ?>
				</div>
				<div class="span4">
					<?php echo $form->textFieldRow($model,'province',array('class'=>'span12','maxlength'=>100)); ?>
				</div>
				<div class="span4">
					<?php echo $form->textFieldRow($model,'postcode',array('class'=>'span12','maxlength'=>20)); ?>
				</div>
			</div>
	...
	<div class="span4">
		...
		<div class="widgetbox block-rightcontent">                        
		    <div class="headtitle">
		        <h4 class="widgettitle">Informasi Member</h4>
		    </div>
		    <div class="widgetcontent">
				<dl>
					<dt>Saldo</dt>
					<dd><?php echo Cart::money($model->saldo) ?></dd>
				</dl>
		    </div>
		</div>
	</div>
