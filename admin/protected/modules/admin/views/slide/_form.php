		...
		<div class="widgetcontent">
			...
			*/ ?>
			...
			foreach ($modelDesc as $key => $value) {
			    ...
			    echo $form->textField($value,'['.$lang->code.']url',array('class'=>'span8', 'maxlength'=>100));
			    ?>
			    <span class="pj-multilang-input"><img src="<?php echo Yii::app()->baseUrl.'/asset/backend/language/'.$lang->code.'.png' ?>"></span>
			    <span class="help-inline _em_" style="display: none;">Please correct the error</span>
				</div>
	...
	<div class="span4">
		...
		<div class="widgetbox block-rightcontent">                        
		    ...
		    <div class="widgetcontent">
				...
				'hint'=>'<b>Note:</b> Ukuran gambar adalah 1900 x 1150px. Gambar yang lebih besar akan ter-crop otomatis', 'style'=>"width: 100%")); ?>
				<?php if ($model->scenario == 'update'): ?>
				<img style="width: 100%;" src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(1900,1150, '/images/slide/'.$model->image , array('method' => 'resize', 'quality' => '90')) ?>"/>
				<?php endif; ?>
		    </div>
		</div>
