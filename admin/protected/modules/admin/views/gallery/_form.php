		...
		<div class="widget">
			...
			<div class="widgetcontent">
				...
				<div class="row-fluid">
					...
					<div class="span6 hide hidden">
						...
						<div class="controls">
							<select id="Gallery_topik_id" name="Gallery[topik_id]" class="input-block-level">
								...
								<?php /*<option value="">---- Choose Category ----</option>
					...
					<div class="span6">
				    	...
				    	<div class="category-tempel">
				    		<?php foreach ($modelCategory as $ke => $val): ?>
							<div class="controls">
								<select id="PrdCategoryProduct_<?php echo $ke ?>" name="PrdCategoryProduct[]" class="input-block-level">
									<?php 
									$dataCategory = (PrdCategory::model()->categoryTree('category', $this->languageID));
									?>
									<option value="">---- Choose Category ----</option>
								...
								<script type="text/javascript">
								$('#PrdCategoryProduct_<?php echo $ke ?>').val('<?php echo $val->category_id ?>');
								</script>
							</div>
				    		<?php endforeach ?>
				    	</div>
					...
					*/ ?>
					...
					<div class="row-fluid">
						<div class="span6">
							<div class="pj-multilang-wrap myLanguage control-group" style="display: <?php if ($key==$this->setting['lang_deff']): ?>block<?php else: ?>none<?php endif ?>;" data-id="<?php echo $lang->id ?>">
							<?php
							echo $form->labelEx($value, '['.$lang->code.']title_bold');
						    echo $form->textField($value,'['.$lang->code.']title_bold',array('class'=>'span8', 'maxlength'=>100));
						    ?>
						    <span class="pj-multilang-input"><img src="<?php echo Yii::app()->baseUrl.'/asset/backend/language/'.$lang->code.'.png' ?>"></span>
						    <span class="help-inline _em_" style="display: none;">Please correct the error</span>
							</div>
					...
					<div class="pj-multilang-wrap myLanguage control-group" style="display: <?php if ($key==$this->setting['lang_deff']): ?>block<?php else: ?>none<?php endif ?>;" data-id="<?php echo $lang->id ?>">
					<?php
					echo $form->labelEx($value, '['.$lang->code.']features');
				    echo $form->textArea($value,'['.$lang->code.']features',array('class'=>'span5 redactor', 'maxlength'=>200));
				    ?>
				    <span class="pj-multilang-input"><img src="<?php echo Yii::app()->baseUrl.'/asset/backend/language/'.$lang->code.'.png' ?>"></span>
				    <span class="help-inline _em_" style="display: none;">Please correct the error</span>
					</div>
				    ...
				    echo $form->textArea($value,'['.$lang->code.']benefit',array('class'=>'span5 redactor', 'maxlength'=>200));
				    ?>
				    <span class="pj-multilang-input"><img src="<?php echo Yii::app()->baseUrl.'/asset/backend/language/'.$lang->code.'.png' ?>"></span>
				    <span class="help-inline _em_" style="display: none;">Please correct the error</span>
					</div>
				...
				<?php /*
					...
					<div class="row-fluid">
						<div class="span6">
				        	<?php echo $form->textFieldRow($model, 'color',array('class'=>'input-block-level', 'placeholder'=>'Masukkan kode HEX')); ?>
							
						</div>
						<div class="span6">
				        	<?php echo $form->dropDownListRow($model, 'orientation', array(
				        		'0'=>'Vertical',
				        		'1'=>'Horizontal',
				        	)); ?>
		...
		<div class="row-fluid">
			<div class="span6">
				...
				<div class="widgetbox block-rightcontent">                        
				    <div class="headtitle">
				        <h4 class="widgettitle">Nutrition Facts</h4>
				    </div>
				    <div class="widgetcontent">
						<?php echo $form->fileFieldRow($model,'image_nutrition',array(
						'hint'=>'<b>Note:</b> Ukuran gambar adalah width 403', 'style'=>"width: 100%")); ?>
						<?php if ($model->scenario == 'update'): ?>
						<img style="max-width: 100%;" src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(200,200, '/images/gallery/'.$model->image_nutrition , array('method' => 'resize', 'quality' => '90')) ?>"/>
						<?php endif; ?>
				    </div>
				</div>
			</div>
			<div class="span6">
				...
				<div class="widgetbox block-rightcontent">                        
				    <div class="headtitle">
				        <h4 class="widgettitle">Gambar Background</h4>
				    </div>
				    <div class="widgetcontent">
						<?php echo $form->fileFieldRow($model,'image_background',array(
						'hint'=>'<b>Note:</b> Ukuran gambar adalah 620 x 1114px. Gambar yang lebih besar akan ter-crop otomatis', 'style'=>"width: 100%")); ?>
						<?php if ($model->scenario == 'update'): ?>
						<img style="max-width: 100%;" src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(200,200, '/images/gallery/'.$model->image_background , array('method' => 'resize', 'quality' => '90')) ?>"/>
						<?php endif; ?>
				    </div>
				</div>
			</div>
	...
	<div class="span4">
		...
		<div class="widgetbox block-rightcontent">                        
		    ...
		    <div class="widgetcontent">
				...
				'hint'=>'<b>Note:</b> Ukuran gambar adalah 184 x 559px. Gambar yang lebih besar akan ter-crop otomatis', 'style'=>"width: 100%")); ?>
				<?php if ($model->scenario == 'update'): ?>
